...
Despite the unusual damage pattern, after reducing typical read-length filters of 30bp to 25bp, the authors did not detect any major effects in downstream analysis of the shotgun data. They were able to perform routine human population genetics analysis as normal.