...
During replication, when it encounters a uracil, it cannot proceed with extending the newly forming complement strand. 
...
In contrast, the original complementary DNA strand (that does not have the uracil), which is filled-in by T4 DNA polymerase during the blunt-ending step of the double-stranded library preparation [@Briggs2007-ao], will still contain the complementary A nucleotide.
