...
#| fig-cap: Example of a smiley plot of a double stranded DNA library. Data taken from library COD076E1bL1 of [@Star2017-cj]. Damage data generated using [DamageProfiler](/intro.qmd) and plotted using R and tidyverse packages [@Wickham2019-ot].
#| echo: false
#| warning: false
#| error: false
